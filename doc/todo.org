* To do items [83%]
** =SortingDesk= [42%]
*** DONE Retrieve random item from the list and create bin off it
- State "DONE"       from "TODO"       [2014-11-24 Mon 17:58]
*** DONE Set =ranker= to random one and create bin
- State "DONE"       from "TODO"       [2014-11-25 Tue 06:41]
*** DONE Rename =ranker= to =label=
- State "DONE"       from "TODO"       [2014-11-25 Tue 07:40]
*** TODO Allow bins to be created by dragging items out of the list
*** TODO Clicking on a bin selects it as the active item ranker
*** TODO Handle removal of currently active bin
*** TODO =addBin=: how to deal with the =ranker= argument?
...
** DONE =BinDefault= . =click= handler invokes private method
- State "DONE"       from "TODO"       [2014-11-25 Tue 09:27]
Specifically, the =click= handler in =BinDefault.initialise= invokes the private method =onClick_= of =ControllerBin=.
** TODO =onRequestStart/End= are not triggered in =SortingDesk='s constructor
** TODO Revisit =sorting_desk-live.html= example
...
** DONE Rename callbacks
- State "DONE"       from "TODO"       [2014-11-25 Tue 07:14]
Given that the =TextItem= prefixed classes have been renamed to =Item=, it then follows that the callbacks prefixed with the string =text= should also be renamed to =item=.
** DONE Implement explicit initialisation of =SortingQueue=
- State "DONE"       from "TODO"       [2014-11-25 Tue 07:04]
This is needed so as to support clients with more complicated instantiation processes, as is the case with =SortingDesk=.
...
** DONE =ControllerButtonDismiss=: must allow clients to register interested scopes and receive events when these occur
- State "DONE"       from "TODO"       [2014-11-22 Sat 08:10]
** DONE Create =SortingDesk= client
...
** DONE =ControllerKeyboard=: must allow clients to process interesting events
- State "DONE"       from "TODO"       [2014-11-22 Sat 07:43]
