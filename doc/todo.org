...
*** TODO Stop ongoing requests when different bin is made active
...
*** All
*** Chrome
**** TODO Create browser action that opens extension's window
User may close the extension window at any time for whatever reason. This means a way of re-opening the extension window at any time must exist.

**** TODO Always positioning extension window in the first screen
Must account for the fact that the main browser window may be in the second window and resize it, if needs be.
