* To do items [70%]
** TODO Review `Instance' and break it up into smaller components
** TODO Rename `list' to `items'
** TODO Rename `container' to `bins'
** TODO Remove hardcoded `less' and `more' CSS classes
