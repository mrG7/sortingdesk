...
- State "DONE"       from "TODO"       [2014-12-24 Wed 13:37]
+ Rename existing =SortingDesk= component to =SortingBinsExample= and its source file to =sorting-bins-example.js=.
+ Rename =SortingDossier= component to =SortingDesk=.
...
*** DONE Append string `live´ to API source file
- State "DONE"       from "TODO"       [2014-12-24 Wed 13:46]
