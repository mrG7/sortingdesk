* To do items [73%]
** TODO Allow a text item to be sorted into a non-bin container (dismiss)
** TODO A bin's shortcut is still active after it is deleted
...
** WAIT [#A] Allow secondary and sub bin names to be edited
